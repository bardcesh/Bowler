...
serial_number = 'MOD-PM-00233' # Specific to this monitoring device
...
wk <- read_csv("https://raw.githubusercontent.com/bardcesh/Bowler/main/data/bowler.csv", col_types = "cddc") 
...
write_csv(recent_data_h,paste0('data/bowler.csv'),append = T)   
